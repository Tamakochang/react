    ...
    return (
      <div className="row">
        <div className="col-md-8">
          <div className="container border" style={{marginLeft: '5px', padding: '20px'}}>
            { menus.map( menu =>
                <div className="row">
        ...
        <div className="col-md-4">
          <div className="container border" style={{marginRight: '10px', padding: '20px'}}>
            ...
            <hr/>
            {this.state.cart.length > 0? <p>Total: {this.state.total} ฿</p> : <div className="text-center">Empty Cart</div>}
          </div>
        </div>
      </div>
    )
